...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("--\tOrdem número telefone2\t--");
		// precisamos organizar os valores. Logo:
		...
		System.out.println("--\tOrdem número telefone3\t--");
		// precisamos organizar os valores. Logo:
		...
		System.out.println("--\tOrdem número telefone4\t--");
		// precisamos organizar os valores. Logo:
		Set<Map.Entry<Integer, Contato>> set4 = new TreeSet<>(
				Comparator.comparing(
						cont1 ->cont1.getValue().getNumero()));
